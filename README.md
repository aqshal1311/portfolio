...
Let me introduce myself, I'm **Aqshal Hadi Alifvyansyach**. On this occasion, I'd like to share the portfolio website project that I've developed.

## 🚀 Live Demo

**Website Link:** [http://localhost:5173/](http://localhost:5173/)
...
```bash
git clone https://github.com/aqshal1311/portofolio.git
cd portofolio
```
...
INSERT INTO public.certificated ("img")
VALUES ('Sertifikat IICF 2024 - Aqshal Hadi Alifvyansyach_page-0001.jpg');

-- Insert one example comment
INSERT INTO public.portfolio_comments (content, user_name) 
VALUES ('Created By Aqshal Hadi Alifvyansyach', 'Ahalief');
...
VITE_SUPABASE_URL=//vzrhylzbcaumwxnzzddl.supabase.co
VITE_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ6cmh5bHpiY2F1bXd4bnp6ZGRsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQ0MDg3MjIsImV4cCI6MjA3OTk4NDcyMn0.b6QhGQuKBXFOS6Iz8rN8IRVDM0J4XO1oXin9O-hpHRA
```
...
**Aqshal Hadi Alifvyansyach**
  ...
  - GitHub: [AhAlief](https://github.com/aqshal1311)
