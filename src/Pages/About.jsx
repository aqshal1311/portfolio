        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
             ...
             Engineering, khususnya software development dan data processing. Menguasai database
             management, data analysis, serta information security. Memiliki keterampilan praktis dalam
             penggunaan berbagai bahasa pemrograman dan tools pengembangan perangkat lunak. Siap
             berkontribusi secara profesional dalam tim yang dinamis untuk mendukung pencapaian tujuan
             organisasi.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1-uIE9H3kP3zByCQZ8bFNAmXXtvfx_uXR/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
